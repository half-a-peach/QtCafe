...
void lineDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const  //получение и установление значения
{
...
void lineDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const     //данные для редактирования
{
...
void lineDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const  //выделение цветом элемента
{
